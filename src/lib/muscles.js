...
const RULES = [
  ...
  { kw: ['hip thrust', 'glute', 'bridge', 'kickback'], groups: { glutes: 1, hamstrings: 0.4 } },
  ...
  { kw: ['triceps', 'tricep', 'pushdown', 'skullcrusher', 'skull crusher', 'kickback', 'close grip', 'overhead extension'], groups: { triceps: 1 } },
  { kw: ['curl', 'biceps', 'bicep', 'chin'], not: ['leg curl'], groups: { biceps: 1, forearms: 0.4 } },
  { kw: ['hammer'], groups: { biceps: 0.9, forearms: 0.7 } },
  { kw: ['row', 'pulldown', 'pull-up', 'pullup', 'pull up', 'lat', 'pullover'], groups: { back: 1, biceps: 0.5 } },
