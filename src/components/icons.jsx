...
// Minimal line-icon set (Feather-style, 24px, stroke = currentColor) so the
// mobile tab bar / More menu feel like a native iOS app without shipping image assets.
const Svg = (props) => (
...
const PATHS = {
  ...
  flame: <path d="M12 2c1 3 4 4.6 4 8a4 4 0 0 1-8 0c0-1.1.4-2.1 1-3-2 .9-4 3.2-4 6.2A7 7 0 0 0 19 13c0-5-4-8-7-11z" />,
  dumbbell: (
    <>
...
export function Icon({ name, ...rest }) {
  return <Svg {...rest}>{PATHS[name] || PATHS.activity}</Svg>
}
